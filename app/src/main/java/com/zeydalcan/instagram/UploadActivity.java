...
public class UploadActivity extends AppCompatActivity {
    private ActivityUploadActictyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUploadActictyBinding.inflate(getLayoutInflater());
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    newReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            postData.put("likeState",likeState);
      ...
      permissionLauncher=registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
          ...
          public void onActivityResult(Boolean result) {
           if (result){
               ...
               Toast.makeText(UploadActivity.this, "You must give permission", Toast.LENGTH_SHORT).show();
